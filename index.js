...
// 1.
// function countyrs (id){
//   console.log(north.find(item => item.id== id).shipAddress.country);
// }
// countyrs(10271)
...
//     {
//       const namess = north[i];
//       const {id, shipName , shipAddress:{country, city}} =namess;
//       console.log("ID: ${id}, shipname: ${shipName}, Country: ${country},City:${city}");
...
// 2.
// function countyrs (x){
//   console.log(north.find(item => item.shipAddress.country == x));
// }
// countyrs("USA");
...
//   let object = north.find(item => item.id == id);
//   let sumprofit = 0;
//   object.details.forEach(item => {
//     sumprofit+=((1-item.discount)*item.quantity*item.unitPrice);
//   })
...
// 4.
// function total (id) {
//   console.log(north.find(item => item.id ==id).details.length);
// }
// total(10271)